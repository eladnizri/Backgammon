...
(function () {
  ...
  /* סמל היחידה — טבעת, תורן-צלב מרכזי, אשכולות תרנים, גלים ואלבטרוס
     דואה. רק כנפי הציפור הן קבוצות נפרדות, כדי שאפשר יהיה לנפנף אותן. */
  function albatrossSvg(side) {
    return `<svg class="emblem ${side}" viewBox="0 0 400 400" aria-hidden="true">
      <g class="ink">
        <circle cx="200" cy="200" r="190"/>
        <circle cx="200" cy="200" r="180"/>
        <!-- תורן מרכזי עם צלב -->
        <line x1="200" y1="92"  x2="200" y2="286"/>
        <line x1="188" y1="101" x2="212" y2="101"/>
        <line x1="172" y1="116" x2="228" y2="116"/>
        <line x1="183" y1="129" x2="217" y2="129"/>
        <line x1="181" y1="259" x2="221" y2="259"/>
        <!-- אשכול תרנים שמאלי -->
        <line x1="114" y1="184" x2="173" y2="184"/>
        <line x1="126" y1="166" x2="126" y2="199"/>
        <line x1="140" y1="169" x2="140" y2="199"/>
        <line x1="154" y1="166" x2="154" y2="199"/>
        <line x1="167" y1="171" x2="167" y2="199"/>
        <!-- אשכול תרנים ימני -->
        <line x1="230" y1="184" x2="284" y2="184"/>
        <line x1="240" y1="168" x2="240" y2="199"/>
        <line x1="254" y1="166" x2="254" y2="199"/>
        <line x1="268" y1="170" x2="268" y2="199"/>
        <!-- גלים -->
        <path d="M114 210 q11 -9 22 0 t22 0 t22 0 t22 0 t22 0 t22 0"/>
        <path d="M118 226 q11 -9 22 0 t22 0 t22 0 t22 0 t22 0 t22 0"/>
        <path d="M126 241 q11 -8 22 0 t22 0 t22 0 t22 0 t22 0"/>
      </g>
      <g class="bird">
        <path class="body" d="M200 160 L219 170 L211 182 Q202 177 198 167 Z"/>
        <g class="wing left"><path d="M206 165 C165 141 121 130 92 133 C126 142 170 157 206 174 Z"/></g>
        <g class="wing right"><path d="M210 168 C248 182 276 206 305 240 C273 213 241 191 210 177 Z"/></g>
      </g>
    </svg>`;
  }
